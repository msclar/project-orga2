...
\end{itemize}
A continuación presentamos los tiempos de ejecución de cada función con y sim SIMD. Para todas ellas se ejcutó el código con $max_i = max_j$ (matriz de discretización cuadrada) y variando $max_i$ (su lado) entre $10$ y $290$ con diferencia de $40$ entre cada tamaño.

\textbf{FALTAN LOS NUMEROS DEL EJE X!!!}
...
Además, notemos que estas dos funciones son en las que se observa mayor ganancia usando SIMD. Para visualizar esto mejor mostramos el siguiente gráfico que mide la proporción entre el tiempo sin SIMD y con SIMD:
