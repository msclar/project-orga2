...
grandes rasgos, los tratamientos ultilizados consiste en colocar un 
...
\begin{center}
	\includegraphics[scale = 0.5]{tejido.png}
\end{center}

Como la resolución de esta ecuación ocupa una parte no despreciable 
del cómputo de sus algoritmos completos, lo implementaremos en C plano, 
en ASM sin SIMD y con SIMD y compararemos los tiempos de ejecución 
obtenidos con cada una (compilando con gcc e icc). Creemos que 
...
en C que resuelva correctamente. La comprobación de que los resultados 
fue no trivial, e incluyó consultas a diversos integrantes del LSC para
realizar un análisis cuantitativo de los resultados. Una explicación del
