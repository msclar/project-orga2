...
La observación más importante es notar que a lo largo de todo el trabajo los cálculos importantes a realizar son de la
...
\item Cálculo del error de Laplace.
\end{itemize} 

También hay cálculos fácilmente paralelizables, de naturaleza más simple, que se incluyeron en el trabajo:
